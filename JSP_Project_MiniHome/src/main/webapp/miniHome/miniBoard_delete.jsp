                ...
                <div class="main">
                  <div class="post-wrap">
                    <div class="freeBoard-wrap">
                      <form action="miniBoard_updateOk.jsp" enctype="multipart/form-data" method="post" onsubmit="return formCheck();">
							<%-- 여기에서 몇개를 숨겨서 가지고 가자 --%>
							...
							<table>
								<tr>
									<td colspan="4" class="title">
										<h1 style="font-weight:900">게시물 삭제하기</h1>
									</td>
								</tr>
								...
								<tr>
									...
									<td >
										...
										required="required" readonly="readonly" value="${vo.userid}" maxlength="30" readonly/>
									</td>
									<td class="item" style="width:80px;">비밀번호</td>
									<td >
										<input type="password" name="password" id="password"
										required="required" maxlength="30"style="width:165px;"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										...
										id="subject" required="required" size="90" maxlength="100" value="${vo.subject }" style="width:450px"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="content" id="content" cols="0" rows="9">${vo.content }</textarea>
									</td>
								</tr>
								...
								<tr>
									<td colspan="4" style="border: none; text-align: right;">
										<div style="text-align:right; margin:0 20px 10px 0; padding:10px;">
											...
											onclick='sendPost("miniBoard.jsp",{"p":${p},"s":${s },"b":${b }})' value="목록" >
										</div>
									</td>
								</tr>
							</table>
