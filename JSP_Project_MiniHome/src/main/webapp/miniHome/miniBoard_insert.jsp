							...
							<table>
								<tr>
									<td colspan="4" class="title">
										<h1 style="font-weight:900;">자유게시판 새글쓰기</h1>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="content" id="content" cols="0" rows="9" placeholder="내용을 입력해주세요"></textarea>
									</td>
								</tr>
								...
								<tr>
									<td colspan="4" style="border: none; text-align: right;">
										<div style="text-align:right; margin:0 20px 10px 0; padding:10px;">
											...
											onclick='sendPost("miniBoard.jsp?userid=${userVO.getUserid() }",{"p":${p},"s":${s },"b":${b }})' value="목록" >
										</div>
									</td>
								</tr>
							</table>
