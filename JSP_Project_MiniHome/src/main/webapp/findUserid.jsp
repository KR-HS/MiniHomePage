...
<body>
	...
	<div id="login_box">
		<form id='login_form' action="${pageContext.request.contextPath }/findUseridOk.jsp" method="post" class="form-horizontal">
			<div class="loginfont">  아이디 찾기</div>

			<div class="idfont">이름</div>
			<!-- 아이디 데이터를 받아오는 input -->
			<div class="idpw">
			...
			<div class="idpw">
				<input id="password" type="text" class="form-control"
					name="phone" placeholder="전화번호 입력(ex. 010-0000-0000)" required>
			</div>
			...
			<div id="login_bottom_box">
				<input class="loginbutton" type="submit" value="아이디찾기"><br>
				<a href="${pageContext.request.contextPath}/login.jsp">
					<input class="join" type="button" value="로그인하기"></a>
			</div>
