				...
				<div class="icons_wrapper">						
					<c:if test="${empty sessionScope.memberVO }">
						<div class="icon_wrapper">
							<a href="login.jsp" class="icon fa fa-toggle-on fa-2x" target="_blank"></a>
						</div>
					</c:if>
						<div class="icon_wrapper" >
						...
						<div class="icon_wrapper">
							<a href="#" class="icon fa fa-envelope fa-2x" target="_blank"></a>
						</div>
				</div>

				<div style="text-align:center;padding:20px;">
					<c:if test="${empty sessionScope.memberVO }">
						<input class="start" type="button" value="시작하기" onclick="location.href='login.jsp'">
					</c:if>
					
					<c:if test="${not empty sessionScope.memberVO }">
						<input class="start" type="button" value="시작하기" onclick="window.open('miniHome/miniHome.jsp', 'popup01','width=950, height=600, left=400, top=150,scrollbars= 0, toolbar=0, menubar=yes')">
